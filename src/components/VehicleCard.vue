...
<template>
  <article class="card">
    ...
    <div class="soc">
      <div class="soc__row">
        <span>SOC</span><strong>{{ v.soc.toFixed(0) }}%</strong>
      </div>
      <div class="soc__bar">
    ...
    <dl class="stats">
      <div>
        <dt>Speed</dt>
        <dd>{{ v.speed.toFixed(0) }} km/h</dd>
      </div>
      <div>
        <dt>Temp</dt>
        <dd>{{ v.temp.toFixed(0) }}°C</dd>
      </div>
      <div>
        <dt>Distance</dt>
        <dd>{{ v.distance.toFixed(2) }} km</dd>
      </div>
      <div>
        <dt>Eff.</dt>
        <dd>{{ v.efficiency.toFixed(2) }} km/kWh</dd>
      </div>
      <div style="grid-column: 1 / -1">
        <dt>Tires (bar)</dt>
        <dd>
          FL {{ v.tireFL.toFixed(2) }} • FR {{ v.tireFR.toFixed(2) }} • RL
          {{ v.tireRL.toFixed(2) }} • RR {{ v.tireRR.toFixed(2) }}
        </dd>
      </div>
    </dl>
  </article>
